  ...
  return (
    <Box>
      ...
      <Box mt='20px' ml='30px' mb='30px'>
        <Text size='20px' c='#1F4145' fw={600}>Patient Details</Text>
      ...
      <Text c="#1F4145" size="20px" fw={600} mb='20px'>
        ...
        <Box style={{border: '2px solid #000000', borderRadius: '25px'}} radius='25px' h='257px' w='338px' align='left'>
        ...
        <Grid>
          <Grid.Col span={3}>
              <Flex w='128px' h='37px' radius='xl' align='center' justify='center'  style={{border: '2px solid #089BAB',borderRadius: '50px'}}>
                <Text size="16px"  fw={600} c='#089BAB'>Weakness</Text>
              </Flex>
          </Grid.Col>
          <Grid.Col span={3}>
              <Flex w='128px' h='37px' radius='xl' align='center' justify='center'  style={{border: '2px solid #089BAB',borderRadius: '50px'}}>
        ...
        <Text c="#1F4145" size="12px" fw={600} mb='20px' style={{lineHeight:'20px'}}>
        These symptoms often align with respiratory infections, such as the COMMON COLD or FLU. The muscle and joint ache might also be associated with these viral infections.
        
        However, it's important to consider other potential causes, including allergies, stress, or underlying health conditions. 
        </Text>
        </Box>
        </Box>
        <Button
